...
$(document).ready(function () {
    ...
    glbUtil_MessageOnSubmit = "¿Desea continuar con generacion de hospedaje?";
});
...
function fnc_Click() {
    $("#btnBuscar").click(function (e) {
        ...
        window.location.href = $("#hdnRutaWeb").val() + "Mascota/Busqueda/1";
    });
    ...
    $("#btnReservar").click(function (e) {
        ...
        fncUtil_Loading("show");
        window.location.href = $("#hdnRutaWeb").val() + "Reserva/LugarReserva/" + rowData.CodigoMascota + "/1";
    });
...
function fnc_Listar() {
    ...
    var oAjax = new fAjax();
    oAjax.Url = "Hospedaje/ListarDetalle";
