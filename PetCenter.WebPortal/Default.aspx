<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="PetCenter.WebPortal.Default" %>
...
<head>
  ...
  <link href="<%= ResolveClientUrl("~/public/css/estilos.css") %>" rel="stylesheet" type="text/css" />
  
  <script src="<%= ResolveClientUrl("~/public/js/jquery-1.11.3.min.js") %>" type="text/javascript"></script>
...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage"><img src="<%= ResolveClientUrl("~/public/images/img/logo.png") %>"/></a>
    </div>
